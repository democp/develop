...
<span id="alert"></span>
<div class="col-md-10 pdn"><input type="text" class="form-control" id="barcd" placeholder="Scan Your Barcode Here" autofocus="true" onchange="add(this.value)"></div>
...
<td>PartNumber			<input type="text" class="form-control" onkeyup="searchResult('prtno',this.value)"></td>
