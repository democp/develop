...
<script type="text/javascript" src="js/js/qrcode.js"></script>
<script type="text/javascript" src="js/js/qrcode.min.js"></script>
</head>
<body onload="printBarcode()" style="font-family: monospace;font-weight: 600;width: 75mm;height: 35mm;overflow:hidden;">
<!-- <body onload="printBill()" style="font-family: monospace;font-weight: 600;width: 75mm;height: 35mm;overflow:hidden;"> -->
<div class="pagewth">
<div class=" padth" id="barcode">
 <div style="width: 75mm;height: 38mm;overflow:hidden;">
    
	<div class="container-fluid pdn" style="margin-top: 4%;margin-left: -8mm;">
	
	<div class="col-md-5">
	<p class="pull-right">T P / N &nbsp; :</p>
	</div>
	<div class="col-md-7">
...
<p class="pull-right">Desc&nbsp;&nbsp; &nbsp; :</p>
	...
	<p>${pm.pnt_prt_des }</p>
		...
		<div class="col-md-5">
	<p class="pull-right">S / N&nbsp;&nbsp;&nbsp; &nbsp;  :</p>
	</div>
	<div class="col-md-7">
	<p>${pm.pnt_cmy_cd }${pm.pnt_srz_no }</p>
	</div>
	<div class="col-md-5">
<p class="pull-right">Date&nbsp;&nbsp;&nbsp; &nbsp; :</p>
	</div>
	<div class="col-md-5">
	<p><fmt:formatDate pattern = "dd/MM/yyyy" value = "${pm.pnt_dt }" /></p>
	</div>
	<%-- <div class="col-md-5">
<p class="pull-right">BrCd&nbsp;&nbsp;&nbsp; &nbsp; :</p>
	</div>
	<div class="col-md-5">
	<p>${pm.pnt_prt_bar_cd }</p>
	</div> --%>

	<div class="col-md-2" style="width: 16%;margin-left: 0%;margin-top: -1%;">
	<div id="qrcode" style="width: 100%;display: block;margin: auto;margin-top: -30%;margin-left: -46%;"></div>
<!-- <img src="http://www.barcodetools.com/generator/images/barcode-tag.png" class="img-responsive" style="width: 100%;display: block;margin: auto;margin-top: -30%;margin-left: -46%;"> -->
	</div>
	</div>
</div>
...
<input type="hidden" id="printqrcode" value="${pm.pnt_bar_cd}">
...
<script type="text/javascript">
new QRCode(document.getElementById("qrcode"), document.getElementById("printqrcode").value);
</script>
</body>
</html>